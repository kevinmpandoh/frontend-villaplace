...
import Empty from "../Empty"; // Sesuaikan dengan path file
...
describe("Empty Component", () => {
  ...
  test("renders the empty image correctly", () => {
    ...
    const image = screen.getByAltText("empty") as HTMLImageElement;
  ...
  test("has the correct structure and classes", () => {
    ...
    const container = screen.getByAltText("empty").closest("div");
