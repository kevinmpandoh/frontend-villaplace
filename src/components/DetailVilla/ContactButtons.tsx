...
const ContactButtons = ({ ownerPhone, ownerEmail }: ContactButtonsProps) => {
  const formatPhoneNumber = (phone: string) => {
    // Jika nomor dimulai dengan "0", ubah menjadi "62"
    if (phone.startsWith("0")) {
      return `62${phone.slice(1)}`;
    }
    return phone; // Jika sudah berformat "62", kembalikan langsung
  };
  ...
  return (
    <div className="mt-6">
      <h2 className="text-lg font-semibold mb-2">Hubungi via:</h2>
