...
const DashboardAdmin = () => {
  return (
    <div>
      <div className="border-2 rounded-xl items-center mb-3 bg-white p-6 m-8">
        <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 p-8">
        <StatCard
          icon={<Users className="w-14 h-14 text-white border border-white rounded-full bg-green-400 p-2" />}
          title="Total Pengguna"
          value="20"
          bgColor="bg-green-200/80"
        />
        <StatCard
          icon={<Building2 className="w-14 h-14 text-white border border-white rounded-full bg-orange-400 p-2" />}
          title="Total Mitra"
          value="20"
          bgColor="bg-orange-200/80"
        />
        <StatCard
          icon={<Wallet className="w-14 h-14 text-white border border-white rounded-full bg-purple-400 p-2" />}
          title="Total Transaksi"
          value="20"
          bgColor="bg-purple-200/80"
        />
        <StatCard
          icon={<ImageIcon className="w-14 h-14 text-white border border-white rounded-full bg-blue-400 p-2" />}
