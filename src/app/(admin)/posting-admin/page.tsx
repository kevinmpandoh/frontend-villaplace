...
const PostingAdmin = () => {
  ...
  const { data: villaPending } = useFetchData(
    "http://localhost:8000/api/villa/admin?showPending=true",
    {
      withCredentials: true,
    }
  );
  const { data: villaSuccess } = useFetchData(
    "http://localhost:8000/api/villa/admin?showSuccess=true",
    {
      withCredentials: true,
    }
  );
  const { data: villaReject } = useFetchData(
    "http://localhost:8000/api/villa/admin?showRejected=true",
    {
      withCredentials: true,
    }
  );
