      ...
      <div className="relative h-[100vh] w-full -mb-14 -mt-8">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          ...
          <p className="text-md lg:text-xl px-10 md:px-12 lg:px-50 mb-2 text-center">
            Have questions or need assistance? Reach out to our <br/> support team anytime. We re here to help you resolve <br/> issues, anewer queries, and ensure you have the best <br/> experience possible.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            <form className="space-y-6">
              ...
              <div>
                <label htmlFor="pesan" className="block text-gray-700 font-medium mb-2">
                  Pesan
                </label>
                <textarea
                  id="pesan"
